...
";
        ...
        {
            hasDensity = true;
            conditions.Add("tape.density = @density");
        ...
        {
            conditions.Add("tape.color = (SELECT id FROM color WHERE color = @color)");
        ...
        {
            conditions.Add("tape.additive = (SELECT id FROM additive WHERE additive = @additive)");
